...
export default function Scene({ conditions }: SceneProps) {
  ...
  const stylesChange = {
    backgroundHill: {
      ...
      snowyDay: {
        backgroundColor: "rgba(240, 246, 248, 1)",
        outline: "10px solid white",
      },
    },
    hill: {
      ...
      snowyDay: {
        backgroundColor: "rgba(221, 227, 229, 1)",
        outline: "10px solid white",
      },
    },
    leftHill: {
      ...
      snowyDay: {
        backgroundColor: "rgba(198, 205, 209, 1)",
        outline: "10px solid white",
      },
    },
    houseOnHill: {
      ...
      snowyDay: { fill: "rgba(137, 158, 164, 1)" },
    },
    fireContainer: {
  ...
  return (
    <div>
      ...
      >
        ...
        <svg
          className={styles.houseSnow}
          style={stylesChange.houseSnow[conditions]}
          viewBox="0 0 512 512"
          width="100"
          height="100"
        >
